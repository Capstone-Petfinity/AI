...
skin_content_dic={"구진(플라크)":"구진이란 염증성 여드름 병변과 비염증성 여드름 병변의 중간 형태이며 피부의 단단한 덩어리로 직경이 0.5cm~1cm 정도 됩니다. 작고 딱딱한 붉은 색의 병변이나 안에 고름은 잡히지 않은 상태로 나타납니다.",
        "비듬/각질/상피성잔고리": "비듬/각질은 피부 표피에서 건조하고 얇은 형태로 나타나는 표피세포로 생명력이 없는 죽은 세포입니다. 농포나 수포가 파열된 후 나타나는 원형으로 나열된 비듬/각질을 상피성잔고리라고 부릅니다.",
        "태선화 과다색소침착":"태선화 과다색소침착은 피부가 두꺼워지고 단단해져 피부주름이 뚜렷해지는 증상**을 동반하며 피부색이 검게 변하는 질환이며 색소침착의 일반적인 원인으로는 피부 멜라닌 색소 과다, 비정상적 피부 성장, 피부 염증 후 색소침착 등이 있습니다.",
...
eye_content_dic={"색소침착성각막염":"건조증으로 인해 장기간 부족한 눈물량이 지속되면서 만성적인 자극이 각막에 주어지고, 그로 인해 각막에 색소가 침착되는 증상을 의미합니다.",
        ...
        "결막염/비궤양각막질환":"결막염은 눈꺼풀의 안쪽과 흰 눈의 표면(공막)으로 이루어진 결막에 염증이 생긴 질병을 의미합니다. 비궤양성각막질환은 바이러스, 세균 등에 의해 각막에 염증이 발생하되 각막에 궤양(표면이 움푹파이는 현상)이 발생하지 않는 질환입니다. 결막염은 눈이 충혈되고 눈꼽이 나는 것이 특징입니다. 비궤양각막질환은 눈꼽은 없으나 충혈이 되는 경우가 있으며 시력이 저하될 수 있습니다.",
        "정상" : "정상입니다",}
