...
eye_content_dic={"색소침착성각막염":"건조증으로 인해 장기간 부족한 눈물량이 지속되면서 만성적인 자극이 각막에 주어지고, 그로 인해 각막에 색소가 침착되는 증상을 의미합니다.",
        ...
        "결막염/비궤막질환":"결막염은 눈꺼풀의 안쪽과 흰 눈의 표면(공막)으로 이루어진 결막에 염증이 생긴 질병을 의미합니다. 비궤양성각막질환은 바이러스, 세균 등에 의해 각막에 염증이 발생하되 각막에 궤양(표면이 움푹파이는 현상)이 발생하지 않는 질환입니다. 결막염은 눈이 충혈되고 눈꼽이 나는 것이 특징입니다. 비궤양각막질환은 눈꼽은 없으나 충혈이 되는 경우가 있으며 시력이 저하될 수 있습니다.",
